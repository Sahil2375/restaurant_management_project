...
from .views import UpdateDriverLocation, TrackRide, complete_ride, cancel_ride, RiderHistoryView, DriverHistoryView, RideFeedbackView, CalculateFareView, mark_ride_payment
...
urlpatterns = [
    ...
    path('api/ride/payment/<int:ride_id>/', mark_ride_payment, name='mark_ride_payment'),
]
